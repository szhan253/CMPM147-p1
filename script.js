const fillers = {
  ...
  The playground's gate is locked at midnight. There are many $scary all over the midnight playground. You need to cooperate with your friend, $player, to solve some puzzles provided all over the playground to get out of here in $number hours. You might need to $action two $objects together or use the $color $shapes keys or $tools you got before to solve the puzzle. After on puzzle is solved, there are going to be some $color $shapes keys or $tools for you to collect. 
